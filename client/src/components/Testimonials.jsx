const Testimonials = () => {
    ...
    return (
        <>
            ...
            {/* 🧠 Header */}
            <h2 className="text-[42px] font-bold text-center mt-16 mb-1 ml-1 text-gray-700">
                Customer Reviews
            </h2>
            <p className="text-center mb-1 text-gray-500 max-w-lg mx-auto">What our customers say about us</p>
