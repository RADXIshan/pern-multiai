...
const Footer = () => {
  return (
    <footer className="flex flex-col bg-slate-50 items-center justify-around w-full py-16 text-sm text-gray-800/70 font-[Poppins]">
      <nav className="flex flex-wrap items-center gap-6 sm:gap-8 text-center">
